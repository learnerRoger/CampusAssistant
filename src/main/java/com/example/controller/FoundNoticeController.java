...
public class FoundNoticeController {
    ...
    @RequestMapping("/remove/{found_id}")
    public ModelAndView removeFoundNotice(@PathVariable String found_id) throws Exception {
        ModelAndView modelAndView = new ModelAndView();
        foundNoticeService.removeFoundNotice(found_id);
        modelAndView.setViewName("/foundNotice/selectFoundNotice");
        return modelAndView;
    }
}
